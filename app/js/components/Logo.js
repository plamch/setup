    ...
    render () {
        return (
            <div className="logo" id="logo">
                <a itemProp="url">
                    <svg
                        ...
                        itemProp="logo"
                    >
                        <path d="M88.3,258.6c-14,0-25.4-2.1-34.4-6.4S36.2,242,27.6,234.4v-19.1C37.2,224,46.3,230.9,55,236c8.7,5.1,19.7,7.6,32.9,7.6
            ...
            c0,24.5-8.3,45.3-25,62.2S113.1,258.6,88.3,258.6z" />
                        ...
                        <path d="M474.2,255.7H458V148.3c0-22.8,6.4-39.5,19.1-50c6.4-5.2,12.9-9.1,19.7-11.8s13.9-4,21.5-4c13.5,0,25,3.3,34.4,9.8
            ...
            h-16.2V153c0-20.1-4.7-34.5-14-43.2s-20.1-13.1-32.4-13.1c-12.5,0-23.2,4.4-32.2,13.1s-13.4,22-13.4,39.9L474.2,255.7L474.2,255.7z" />
                        <path d="M402.9,234c-4.9,4.2-9.4,7.6-13.4,10.3s-8.8,5.4-14.2,8.1c-8.3,4.2-19.4,6.3-33.1,6.3c-24.3,0-45-8.3-62.2-24.8
